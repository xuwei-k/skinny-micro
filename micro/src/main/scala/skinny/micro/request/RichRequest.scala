  ...
  def multiParameters: MultiParams = {
    val bodyParams: Map[String, Seq[String]] = {
      if (r.getParameterMap.isEmpty
        ...
        && r.getHeader("Content-Type").split(";")(0).trim.equalsIgnoreCase("APPLICATION/X-WWW-FORM-URLENCODED")) {
...
object RichRequest {
  ...
  private val cachedBodyKey: String = "skinny.micro.RichRequest.cachedBody"
